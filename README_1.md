# timp-737-1_fyi
Учебный репозиторий для курса ТИМП(Технологии и методы программирования 2 курс,4 семестр)

Практика 1 "Знакомство с языоком Си"
...
Задание 1
Вариант 8. Количество неположительных чисел. На вход подаётся число 𝑛 ∈ N : 𝑛 ≤ 2147483647, а также 𝑛 чисел 
𝑥𝑖 ∈ Z : |𝑥𝑖| ≤ 2147483647 для любого целого 𝑖 от 1 до 𝑛. Вывести количество чисел 𝑥𝑖: 𝑥𝑖 ≤ 0.

Задание 2
Вариант 14. Сумма нечётных квадратов. На вход подаётся число 𝑛 ∈ N : 𝑛 ≤ 2147483647, а также 𝑛 чисел 
𝑥𝑖 ∈ Z : |𝑥𝑖| ≤ 2147483647 для любого целого 𝑖 от 1 до 𝑛. Вывести значение ∑︁𝑛𝑖=1(𝑖 mod 2) · 𝑥2𝑖.
